...
const SellVehicle = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.ubicacionVehiculo.trim())
      newErrors.ubicacionVehiculo = 'La ubicación del vehículo es requerida.';
    if (!formData.ciudadMatricula.trim())
      newErrors.ciudadMatricula = 'La ciudad de matrícula es requerida.';
  ...
  return (
    <>
      <div className={styles.migajero}>
        <Link className={styles.link} to='/Home'>
          Inicio
        </Link>
        {`${'>'}`}
        <Link className={styles.link} to='/SellVehicle'>
          Vende tu vehiculo
        </Link>
      </div>
          ...
          <fieldset className={styles.formSection}>
            ...
            <div className={styles.formGroup}>
              ...
              <input
                ...
                onChange={handleChange}
                className={`${styles.formInput} ${
                  errors.ubicacionVehiculo ? styles.inputError : ''
                }`}
              />
              {errors.ubicacionVehiculo && (
                <p className={styles.errorMessage}>{errors.ubicacionVehiculo}</p>
              )}
            </div>
            ...
            <div className={styles.formGroup}>
              ...
              />
              {errors.ciudadMatricula && (
                <p className={styles.errorMessage}>{errors.ciudadMatricula}</p>
              )}
            </div>
